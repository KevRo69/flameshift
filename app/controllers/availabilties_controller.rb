class AvailabiltiesController < ApplicationController
  ...
  def edit
    ...
    end_of_next = Date.today.day <= Setting.first.last_day ? (Date.today.at_beginning_of_month + 2.months + params[:month].month).end_of_month : (Date.today.at_beginning_of_month + 3.months + params[:month].month).end_of_month
