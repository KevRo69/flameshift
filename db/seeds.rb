...
User.create!(email: "user2@test.fr", password: "123456", first_name: "David", last_name: "Quibel", CATE: "1", COD_1: "1", team_id: Team.where(number: 2)[0].id)
...
User.create!(email: "user4@test.fr", password: "123456", first_name: "Stéphane", last_name: "Janaudy", CATE: "1", team_id: Team.where(number: 3)[0].id)
User.create!(email: "user5@test.fr", password: "123456", first_name: "Raphael", last_name: "Poulin", CATE: "1", COD_1: "1", team_id: Team.where(number: 2)[0].id)
...
User.create!(email: "user9@test.fr", password: "123456", first_name: "Sebastien", last_name: "Desbois", CATE: "1", team_id: Team.where(number: 1)[0].id)
...
User.create!(email: "user11@test.fr", password: "123456", first_name: "Quentin", last_name: "Vasseur", CE_INC: "1", team_id: Team.where(number: 2)[0].id)
User.create!(email: "user12@test.fr", password: "123456", first_name: "Faustine", last_name: "Desrayaud", CE_INC: "1", team_id: Team.where(number: 1)[0].id)
...
User.create!(email: "user19@test.fr", password: "123456", first_name: "Christophe", last_name: "Billy", validator: "1" ,team_id: Team.where(number: 1)[0].id)
