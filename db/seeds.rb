...
User.create!(email: "nicolasd", password: "123456", first_name: "Nicolas", last_name: "Debost", CE_INC: "1", COD_1: "1", team_id: Team.where(number: 1)[0].id)
User.create!(email: "alexandreb", password: "123456", first_name: "Alexandre", last_name: "Barbier", CE_INC: "1", COD_1: "1", team_id: Team.where(number: 3)[0].id)
...
User.create!(email: "sandrinel", password: "123456", first_name: "Sandrine", last_name: "Legras", CE_INC: "1", team_id: Team.where(number: 2)[0].id)
User.create!(email: "quentinv", password: "123456", first_name: "Quentin", last_name: "Vasseur", CE_INC: "1", validator: "1", team_id: Team.where(number: 2)[0].id)
User.create!(email: "faustined", password: "123456", first_name: "Faustine", last_name: "Desrayaud", CE_INC: "1", validator: "1", team_id: Team.where(number: 1)[0].id)
